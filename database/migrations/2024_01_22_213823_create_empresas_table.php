...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('empresas', function (Blueprint $table) {
            ...
            $table->enum('tipo_empresa', ['NO_DEFINIDO', 'SOCIEDAD_LIMITADA', 'ANÓNIMA', 'DOMINIO', 'SOCIEDAD_ASOCIATIVA', 'EMPRESARIO_INDIVIDUAL', 'OTRA', 'PERSONA_NATURAL', 'SOCIEDAD_COLECTIVA', 'SOCIEDAD_POR_ACCIONES_SIMPLIFICADA', 'SOCIEDAD_DE_RESPONSABILIDAD_LIMITADA', 'SOCIEDAD_EN_COMANDITA_POR_ACCIONES', 'EMPRESA_RURAL_SENA_EMPRENDE_RURAL']);
